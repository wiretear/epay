...
Like: National ID, Driving License, Passport etc. Make sure all information is clearly readable and that it is fully in frame.</p>
 ...
 <a  style="margin-top:33px;"  type="button" class="btn btn-block btn-primary" data-toggle="modal" data-target="#myModal2">UPLOAD</a>
                        </div>
                    </div>
                ...
                <div class="col-md-3 text-center">
                    <div class="box">
                        <div class="box-content">
                          ...
                          <a style="margin-top:90px;" type="button" href="/erapay/kycinfoparameter"  id="basicinfo" class="btn btn-block btn-primary">ADD BASIC INFO</a>
                        </div>
                ...
                <div class="col-md-3 text-center">
                    <div class="box">
                        <div class="box-content">
                            ...
                            <a  style="margin-top:104px;"  type="button" id="introducerbtn" href="/erapay/kycaddressinfo" class="btn btn-block btn-primary" >ADDRESS</a>
                        </div>
                    ...
                    <div class="box">
                        <div class="box-content">
                            ...
                            <p>Add your introducer information for official doc.</p>
                             ...
                             <a  style="margin-top:104px;"  type="button" id="introducerbtn" href="/erapay/kycintroducerinfo" class="btn btn-block btn-primary" >INTRODUCER INFO</a>
                        </div>
