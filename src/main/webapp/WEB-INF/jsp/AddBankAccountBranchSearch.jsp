...
<%@ page import="com.era.Userregistration.NewUserRegistrationCMSC1Form"%>
...
<script>
	...
	function doSelect(v1,v2) {
   
    // opener.document.addBankAccountForm.bankCode.value = v1;
     opener.document.addBankAccountForm.branchName.value = v2;
		window.close();
	}
...
<body>
		...
		<div
			...
			<div style="background-color: #f2f2f2;" class="panel panel-default">
				...
				<h1  style="font-family: Lucida Console, Monaco, monospace"class="panel-title text-center">Add Bank Account</h1>
				</div>
				<div class="panel-body">
				<form:form name="addBankAccountSearchForm" method="post"
		modelAttribute="addBankAccountSearchForm"
		action="/erapay/addbankaccountbranchsearchresult">
					<div class="row">
						<div class="margin-bottom col-xs-4 form-group">
							<label class="pull-right">Branch Code</label>
						</div>
						<div class="margin-bottom col-xs-6 form-group">
					...
					<div class="row">
						<div class="margin-bottom col-xs-4 form-group">
							<label class="pull-right">Branch Name</label>
						</div>
						<div class="margin-bottom col-xs-6 form-group">
							<input type="text" name="bankName" id="bankName"
								placeholder="GroupId" class="form-control">
						</div>
					</div>
					<div id="wrapper" >
							<input  type="submit" class ="button "name="login-submit" id="login-submit"
					 		 value="Search">
                            <input type="button" class ="button" onclick="location.href='/erapay/users/search'" value="Clear" >
					</div>
...
<thead>
			...
			<c:forEach var="bo" items="${sessionScope['oAddBankBranchSearchListBO'].addBankBranchSearchList}" varStatus="varSt">
				<tr>
					<td align="center"><c:out value="${bo.branchCode}" /></td>
					<td><c:out value="${bo.branchName}" /></td>
					<td><a href="#" onclick="doSelect('${bo.branchCode}','${bo.branchName}')">Select
					</a></td>
				</tr>
			</c:forEach>
		</table>
