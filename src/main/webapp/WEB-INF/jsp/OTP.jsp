...
<div class="row col-md-8 col-md-offset-2">
      ...
      <div class="panel-heading text-center">Verification</div>
      <div class="panel-body">
      <h3 class="text-center">Use your device to sign in to your EPAY account.</h3>
      <div class="text-center">
           <img   src="${images}/ver_code.png"  alt="Random Name" >
       </div>
         <div style="margin-top:20px;" class="col-md-12">
			<form:form method="post" modelAttribute="oKycForm"
		name="frm" action="/erapay/testhome">
  <div class="form-group col-md-2">
                            
                        </div>
                          <div  class="form-group col-md-9">
                            <label for="first_name">Authentication Code</label>
                             <input type="text"  class="form-control"  placeholder="Enter Authentication Code"/>
                        </div>
             <div class="row">
                              <div class="col-sm-4">
