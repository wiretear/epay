...
<div class="container">
		...
		name="osignUpFormBean" action="/erapay/executesignup">                
  ...
  <div class="form-group">
                <label for="username"><span class="req">* </span> Full Name:</label>
                   <form:input type="text" path="userName"  id="txtFirstName" class="form-control" onkeypress="return isNumberKey(event,this.id)"   required="required" placeholder="Full Name" value="${osignUpFormBean.userName}"/>
