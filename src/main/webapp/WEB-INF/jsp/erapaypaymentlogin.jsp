				...
				<div class="panel panel-login">
					...
					<div class="panel-body">
						<div class="row">
							...
							<div class="col-lg-12">
								<form:form method="post" modelAttribute="oWalletToMerchantPaymentForm"
		name="frm" action="/erapay/executewallettomerchanpaymenttest">
									<div class="form-group">
										<input type="text" name="email"  tabindex="1" class="form-control" placeholder="Username" value="">
									</div>
									<div class="form-group">
