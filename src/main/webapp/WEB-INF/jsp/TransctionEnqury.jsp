...
function updatecustomerkyc(v1,v2)
{
	  window.location = "/erapayadmin/updatecustomerkyc?cusCode="+v1+"&optradio="+v2;
...
<div  class="col-md-6"> <h1  style="text-color:blue;" class="text-center">Transaction History </h1>
<div class="col-md-3"></div>
<hr>
</div>
</div>
<div  style="margin-top:40px;"class="row form-horizontal">
  <div class="col-md-10 col-md-offset-1">
    <form:form method="post" modelAttribute="oKycForm"
		name="frm" action="/erapay/transctionenqurysearch">
  <div class="form-group with-margin">
                        <label for="description " class="col-md-4 control-label">From Date:</label>
                        <div class="col-md-3">
                            <form:input type="text" path="fromDate" class="form-control" value="${oKycForm.fromDate}" id="datepicker"/>
                        </div>
                         <div class="col-md-5">
                      ...
                      <div class="form-group with-margin">
                        <%--@declare id="description"--%><label for="description" class="col-md-4 control-label">To Date:</label>
                        <div class="col-md-3">
                             <form:input type="text" path="toDate" class="form-control" value="${oKycForm.toDate}" id="datepicker1" placeholder=""/>
                        </div>
                        <div class="col-md-5">
                      ...
                      <div class="form-group  col-md-10">
                        ...
                        <input type="submit" name="login-submit" data-dismiss="modal"
														id="login-submit"
...
<thead>
			<tr class="">
			    ...
			    <th width="120px;"class="text-center">Reference No</th>
				<th width="120px;" class="text-center">Transaction Date</th>
				<th width="120px;" class="text-center">Payment Type</th>
    ...
    int counter = 1;
%>
				<c:forEach var="boo" items="${oKycForm.tranapprovalList}">
				<tr>
					<td  width="10px" align="center"><%=counter++%></td>
					 <td  align='center'> <c:out value="${boo.walletid}"/></td>
					 <td  align='center'><c:out value="${boo.docnum}"/></td>
					<td align='center'><c:out value="${boo.trandat}"/></td>
					<td  width="50px;"align='center'><c:out value="${boo.doctype}"/></td>
					<td width="40px;" align='right'><c:out value="${boo.trnamt}"/></td>
					<td align='left'> <c:out value="${boo.narration}"/></td>
					<td width="80px;" align='left'>
					 <button type="submit" onclick="showvoucher('${boo.walletid}','${boo.docnum}','${boo.narration}','${boo.trnamt}')" name="button" class="btn btn-success" id="bt">print voucher </button>
