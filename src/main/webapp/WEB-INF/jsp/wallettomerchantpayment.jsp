...
<div style="margin-top:20px;" class="row col-md-10  col-md-offset-1">
   ...
   <div class="col-xs-4 item-photo">
                ...
                <div class="col-xs-5" style="border:0px solid gray">
                    ...
                    <h3 style="margin-top:0px;"> ${oWalletToMerchantPaymentForm.bdtCurCode}  ${oWalletToMerchantPaymentForm.amount}</h3>
                      <h6 class="title-price">CHARGE</h6>
                    <h3 style="margin-top:0px;">  ${oWalletToMerchantPaymentForm.bdtCurCode}  ${oWalletToMerchantPaymentForm.charge}</h3>
                    <h6 class="title-price">NARRATION</h6>
                    <h3 style="margin-top:0px;"> ${oWalletToMerchantPaymentForm.description}</h3>
                </div>
	</div>
</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form:form method="GET" modelAttribute="oWalletToMerchantPaymentForm"
		name="oWalletToMerchantPaymentForm" action="/erapay/rediectpaymentpage">
<div class="container">
    <div class="row">
        <div class="col-sm-6">
            <br>
...
<div class="form-group">
    ...
    <div class="panel">
      <div class="panel-heading text-center custom-header-panel1">Payment Method</div>
      <div class="panel-body">
           ...
           <div  style="background-color:#e5e5e5"class="panel-body">
				        ...
				        <div class="row">
							...
							<div class="col-sm-6 form-group">
								    ...
								    <div class="btn btn-payment-default btn-block">
										<img src="${images}/era_pay_logo.jpg" width="90%" 	data-toggle="modal" data-target="#myModal"/>
								    </div>
